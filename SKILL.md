...
## 安装方法
将以下指令发送给 OpenClaw，它会自动完成所有安装配置：

```
安装 skill：https://github.com/japinlo/dongguan-plus-skill
```
...
### Step 1：读取飞书凭证
读取你自己的 OpenClaw 配置，获取飞书 App ID、App Secret 和你的用户 open_id，
将这三个值分别写入 dongguan_plus.py 顶部配置区：
- FEISHU_APP_ID
- FEISHU_APP_SECRET
- FEISHU_USER_ID
